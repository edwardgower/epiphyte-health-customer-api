  ...
  properties: {
    body: {
      ...
      properties: {
        ...
        ssn: {
          description: 'social security number for the customer - as this is a demo this is unencrypted and allows for dupliates',
          type: 'string',
          format: 'date',
        },
      },
      //required: ['gender'],
      //todo: add schema for address and phone numbers
    },
  },
  required: ['body'],
};
